...
已内置五类工具：**大模型网关**、**媒体工具**、**文档工具**、**图片工具**、**Agent 资源**；控制台需首次创建 Owner 账号后登录使用。
...
上传本地音频或粘贴音频直链（MP3 / WAV / M4A / FLAC / AAC / OGG 等），自动提取音频并转写为文字；长音频按静音切分并行识别，转写参数与视频转文字共用「工具配置」。
